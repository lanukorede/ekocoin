...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Ekocoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"ekocointools.com", "8.8.8.8"},
    {NULL, NULL}
};

static const char *strTestNetDNSSeed[][2] = {
    {"ekocointools.com", "testnet-seed.ekocointools.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Ekocoin is probably already running."), addrBind.ToString().c_str());
        else

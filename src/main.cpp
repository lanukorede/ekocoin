...
#if defined(NDEBUG)
# error "Ekocoin cannot be compiled without assertions."
#endif
...
uint256 hashGenesisBlock("0xf31e2b2bd6d23151bd799e71e7cee1a0ecfd53e5b2d0f6f0ad554f1de8431879");
static CBigNum bnProofOfWorkLimit(~uint256(0) >> 20); // Ekocoin: starting difficulty is 1 / 2^12
...
const string strMessageMagic = "Ekocoin Signed Message:\n";
...
{
    // Ekocoin: IsDust() detection disabled, allows any valid dust to be relayed.
...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
    ...
    nSubsidy >>= (nHeight / 840000); // Ekocoin: 840k blocks in ~4 years

    return nSubsidy + nFees;
}

static const int64 nTargetTimespan = 10 * 30; // Ekocoin: 5 minutes
static const int64 nTargetSpacing = 1 * 30; // Ekocoin: 30 seconds
...
unsigned int static GetNextWorkRequired(const CBlockIndex* pindexLast, const CBlockHeader *pblock)
{
    ...
    // Ekocoin: This fixes an issue where a 51% attack can change difficulty at will.
...
bool CBlock::CheckBlock(CValidationState &state, bool fCheckPOW, bool fCheckMerkleRoot) const
{
    ...
    // Ekocoin: Special short-term limits to avoid 10,000 BDB lock limit:
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0xf31e2b2bd6d23151bd799e71e7cee1a0ecfd53e5b2d0f6f0ad554f1de8431879");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        // Genesis block
        const char* pszTimestamp = "This is ekocoin";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        assert(block.hashMerkleRoot == uint256("0x4b8626a3044705aa930d3e8082b689795ad796aeabab3542e0577a103454d69c"));
...
unsigned char pchMessageStart[4] = { 0xfb, 0xc0, 0xb6, 0xdb }; // Ekocoin: increase each by adding 2 to bitcoin's value.
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("EkocoinMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("EkocoinMiner : ProcessBlock, block not accepted");
    }

    return true;
}

void static EkocoinMiner(CWallet *pwallet)
{
    printf("EkocoinMiner started\n");
    SetThreadPriority(THREAD_PRIORITY_LOWEST);
    RenameThread("ekocoin-miner");
    ...
    try { loop {
        ...
        printf("Running EkocoinMiner with %"PRIszu" transactions in block (%u bytes)\n", pblock->vtx.size(),
    ...
    {
        printf("EkocoinMiner terminated\n");
        throw;
    }
}
...
void GenerateBitcoins(bool fGenerate, CWallet* pwallet)
{
    ...
    for (int i = 0; i < nThreads; i++)
        minerThreads->create_thread(boost::bind(&EkocoinMiner, pwallet));
}
